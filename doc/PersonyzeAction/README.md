...
If you present this action in a custom way (not through `action.renderOnWebkitView()`), call this function after the action is shown to the user, so action statistics will be updated.
